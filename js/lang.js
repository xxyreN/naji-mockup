...
(function () {
  ...
  document.querySelectorAll('img[src*="img/"]').forEach(function (img) {
    img.addEventListener('error', function () {
      ...
      placeholder.style.cssText = 'background:#E8C9A5;display:flex;align-items:center;justify-content:center;width:100%;height:100%;min-height:200px;font-family:monospace;font-size:12px;color:#8B4513;letter-spacing:0.05em;padding:20px;text-align:center;border:1px dashed rgba(139,69,19,0.3);border-radius:8px;position:absolute;inset:0;';
